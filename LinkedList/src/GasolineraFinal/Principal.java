...
public class Principal {
	...
	public static void main(String[] args) {
		...
		repsol.arraySurtidores[0].getColaCoches().offerLast(new Coche("citroen"));	
		repsol.arraySurtidores[0].setCoche(coche);
		repsol.arraySurtidores[0].getColaCoches().offerLast(new Coche("Renault"));
		repsol.arraySurtidores[0].getColaCoches().offerLast(new Coche("Porche"));
		repsol.arraySurtidores[0].getColaCoches().offerLast(new Coche("Audi"));

		//Posicion1 
		repsol.arraySurtidores[1].getColaCoches().offerLast(new Coche("skoda"));
		
		//Posicion2 vacio

	
		//posicion3
		repsol.arraySurtidores[3].getColaCoches().offerLast(new Coche("seat"));
		
		repsol.arraySurtidores[3].getColaCoches().offerLast(new Coche("dacia"));
